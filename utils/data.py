...
class iCIFAR10(iData):
    ...
    def download_data(self):
        train_dataset = datasets.cifar.CIFAR10("/data0/CL_data", train=True, download=True)
        test_dataset = datasets.cifar.CIFAR10("/data0/CL_data", train=False, download=True)
